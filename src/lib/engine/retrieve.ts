...
const SYNONYMS: Record<string, string[]> = {
  ...
  tenant: ["lessee", "renter", "guest", "licensee", "occupant"],
  // Paying-guest and hostel agreements name the parties differently.
  owner: ["landlord", "lessor", "licensor"],
  room: ["premises", "accommodation", "property"],
  flat: ["premises", "apartment", "property"],
  house: ["premises", "property"],
  food: ["meals", "fee", "fees"],
  visitors: ["guests", "visitor"],
